...
command2 = `uuencode stats-copieurs.zip stats-copieurs.zip | mail -s "Stats copieurs - #{date}" marches-rectorat@ac-amiens.fr rt@ac-amiens.fr tg@ac-amiens.fr`

notify_slack(
  'https://ratatouille.in.ac-amiens.fr:8065/hooks/dc8d79ju4pdz7jk3sraxjtpj4h',
  'rapport-conso-kyocera',
  'kyocera',
  'Rapport de consommation des copieurs généré et envoyé.',
